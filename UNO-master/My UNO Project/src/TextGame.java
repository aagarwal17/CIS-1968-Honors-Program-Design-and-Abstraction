/**
 * Arun, John, Maddy
 * TextGame class serves as our Main class
 * It is the culmination of the other three classes to make a functional Uno Game
 */

import java.util.ArrayList;
import java.util.Scanner;

//The TextGame class includes all the code that allows the game to play
//as well as all the print statements and scanner inputs sent to the console
public class TextGame 
{
	...
	//Method with everything necessary to start the game
	...
	public void initializePlayers()
	{
		...
		for(int i = 0; i < playerCount; i++)
		{
			...
			players.add(new Player(playerName, temporary));
		}
